...
//
//        if (i1000A == i1000B) {
//            System.out.println("i1000A y i1000B apuntan al mismo objeto");
//        }
//        if (i1000A.equals(i1000B)) {
//            System.out.println("i1000A tiene el mismo valor que i1000B");
//        }
//
//        Integer i8A = 4 * 2;
//        Integer i8B = 2 * 2 * 2;
//
//        if (i8A == i8B) {
//            System.out.println("i8A y i8B apuntan al mismo objeto");
//        }
//        if (i8A.equals(i8B)) {
//            System.out.println("i8A tiene el mismo valor que i8B");
//        }
    }

//    Is no longer needed bc I made the same thing with constructors
