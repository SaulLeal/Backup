...
public class MethodReferencesTest {
    ...
    public static void main(String... args) {
        ...
        System.out.println("Printing roster:");
        for (Person p : roster) {
            p.printPerson();
        }
        System.out.println();
        ...
        // With use of Person.compareByAge method
        ...
        // Reference to a Constructor with lambda expression
        Set<Person> rosterSetLambda =  transferElements(roster, () -> {
            return new HashSet<>();
        });

        // Reference to a Constructor with method reference
        Set<Person> rosterSet = transferElements(roster, HashSet::new);

        // Reference to a Constructor with method reference with Type
        Set<Person> rosterSetWithType = transferElements(roster, HashSet<Person>::new);
        ...
        System.out.println("Printing roster order by name");
