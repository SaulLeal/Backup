...
public class RosterTest {
    ...
    public static void main(String... args) {
        ...
        System.out.println("Persons who are eligible for Selective Service " + "(with aggregate operations):");
        ...
        // Approach 10: Use Method References
        System.out.println("Persons who are eligible for Selective Service " + "(with method references):");
        roster
                .stream()
                .filter(p -> p.getGender() == Person.Sex.MALE && p.getAge() >= 18 && p.getAge() <= 25)
